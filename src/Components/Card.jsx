...
const Card = ({ Data }) => {
  ...
  return (
    ...
    <div
      ...
      className={`border border-teal-600 h-[10rem] w-[35rem] my-4 rounded-lg flex justify-center items-center shadow-teal-500 shadow-sm`}
    >
      <div className="w-full max-w-[95%]  h-full max-h-[95%] relative flex justify-around flex-col">
        ...
        <p className="absolute top-0 right-0 text-gray-600">10:32pm</p>
